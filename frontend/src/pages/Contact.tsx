...
const Contact = () => {
  return (
    <div className="w-full h-full py-20  max-container">
      <div className="flex items-center flex-col justify-center gap-24  ">
        <div className="flex items-center justify-center w-full ">
          <div className="flex flex-col gap-2 justify-center">
            <p className="font-bold">Reach out to us</p>
            <h3 className=" font-bold text-6xl">Contact Us</h3>
            <p className="text-black/70 w-[90%] text-xl">
              We’d love to hear from you! Whether you have questions, feedback,
              or partnership inquiries, feel free to reach out.
            </p>
          </div>
          <div className="flex flex-col p-10 w-1/2 gap-6  border-[#226A10] border-4 rounded-xl">
        ...
        <div className="w-full min-h-[528px] relative flex items-center justify-center overflow-hidden rounded-2xl  ">
          <img
            src={OverlayImage}
            className=" absolute w-full h-[528px] object-center -z-10 object-cover rounded-xl brightness-50"
          />
          <div className="w-1/2 text-center h-full flex flex-col text-white items-center justify-center">
            <p className=" font-bold">Subscribe to Our Newsletter</p>
            <h4 className=" font-bold text-5xl">
              Stay updated with the latest transit news!
            </h4>
            <div className="flex py-4 relative w-2/3">
              <Input
              ...
              <Button
                variant="primary"
                className=" absolute rounded-full right-0 px-10"
              >
                Join Newsletter
              </Button>
            </div>
